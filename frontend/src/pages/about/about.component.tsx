    ...
    <div className="about">
      ...
      <h1>Make a Playlist!</h1>
        <div className="content-inner">
          ...
          <p>If you also love the playlist that was generated with this app, you can choose to send it to your phone! Just click the message icon in the playlist section, type in your phone number, and click send!</p>
        </div>
      </div>
    </div>
  )
